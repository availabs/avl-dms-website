...
export default ({value, edit, remove, moveUp, moveDown,}) => {
    if(!value) return false
    return (
        <div className='relative px-4 sm:px-6 lg:px-12 w-full'>
            <h3 className='section-header text-xl tracking-wider mx-auto my-2 font-medium border-b border-t border-color-gray-300 py-1 flex'>
