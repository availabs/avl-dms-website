...
let Edit = React.forwardRef(({ Attribute, id, autoFocus = false, onFocus, onBlur, onChange, value, addToArray, buttonDisabled, ...props }, ref) => {
  value = value || {};
  ...
  return (
    <div className='w-full'>
        <div className='relative px-4 sm:px-6 lg:px-12'>
            <h3 className='section-header text-xl tracking-wider mx-auto mb-2 mt-2 font-medium border-b border-t border-color-gray-300 py-2 flex'>
                {Title ? 
                <Title.Input
                    ref={ ref }
                    className='p-1'
